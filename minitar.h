...
/*
 * Add the name of each file contained in the archive identified by
 * 'archive_name' to the 'files' list. If it's not in the 
 * archive already, it adds it itself. If it's  in there already,
 * it adds the appropriate code/documentation in it. This function should 
